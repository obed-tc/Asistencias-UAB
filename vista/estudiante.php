...
<div class="page-content">
    ...
    if ($sql) {
    ?>
        <a href="registro_estudiante.php" class="btn btn-primary btn-bordered mb-3"><i class="fa-solid fa-plus"></i> &nbsp;REGISTRAR</a>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="usuario.php?id=<?= $datos->id_empleado ?>" onclick="return advertencia(event)" class="btn btn-danger btn-sm-2"><i class="fa-solid fa-trash"></i></a>
                        </td>
                    </tr>
